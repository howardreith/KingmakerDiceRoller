...
namespace KingmakerDiceRoller
{
    public sealed class CompositionRoot
    {
        ...
        public CompositionRoot(Settings settings, IModLogger logger)
        {
            ...
            var skillsSync = new SkillsPhaseSynchronizationService(logger);
        ...
        private bool Enable()
        {
            try
            {
                ...
                enabled = true;
                diagnostics.SetStatus("Enabled; waiting for supported creation or an owned starting-score respec.");
