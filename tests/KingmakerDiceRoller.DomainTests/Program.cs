...
namespace KingmakerDiceRoller.DomainTests
{
    internal static class Program
    {
        ...
        private static int Main()
        {
            ...
            {
                new TestCase("ProductionThemeRecoveryPreservesRollSavedAndDraft", ProductWorkflowTests.ProductionThemeRecoveryPreservesRollSavedAndDraft),
                new TestCase("ThemeRetriesLeaveOwnedCommandDispatchSingle", RollUiPresenterTests.ThemeRetriesLeaveOwnedCommandDispatchSingle),
                new TestCase("ThemeRecoveryPreservesCloseBadgeAndForwardGuards", PreviewSessionContinuityTests.ThemeRecoveryPreservesCloseBadgeAndForwardGuards),
                new TestCase("LiteralSlashChildUsesProductionResolver", NativeThemeResolverTests.LiteralSlashChildUsesProductionResolver),
                new TestCase("LiteralAndPathRemainDistinct", NativeThemeResolverTests.LiteralAndPathRemainDistinct),
                new TestCase("LiteralDoesNotSatisfyHierarchyPath", NativeThemeResolverTests.LiteralDoesNotSatisfyHierarchyPath),
                new TestCase("InactiveDonorsRemainEligible", NativeThemeResolverTests.InactiveDonorsRemainEligible),
                new TestCase("LiteralMatchIsOrdinalAndRejectsDuplicates", NativeThemeResolverTests.LiteralMatchIsOrdinalAndRejectsDuplicates),
                new TestCase("WrongComponentDoesNotSelectUnrelatedText", NativeThemeResolverTests.WrongComponentDoesNotSelectUnrelatedText),
                new TestCase("DuplicateComponentsFailCapability", NativeThemeResolverTests.DuplicateComponentsFailCapability),
                new TestCase("MissingOwnerAndDestroyedComponentsFailClearly", NativeThemeResolverTests.MissingOwnerAndDestroyedComponentsFailClearly),
                new TestCase("AmbiguousPathDoesNotChooseFirstDonor", NativeThemeResolverTests.AmbiguousPathDoesNotChooseFirstDonor),
                new TestCase("OptionalCapabilitiesFailIndependently", NativeThemeResolverTests.OptionalCapabilitiesFailIndependently),
                new TestCase("FailedValidationNeverCommitsPartialCapability", NativeThemeResolverTests.FailedValidationNeverCommitsPartialCapability),
                new TestCase("MissingCriticalCapabilityCannotClaimFullyThemed", NativeThemeResolverTests.MissingCriticalCapabilityCannotClaimFullyThemed),
                new TestCase("LookupAndDiagnosticsAreBounded", NativeThemeResolverTests.LookupAndDiagnosticsAreBounded),
                new TestCase("RecoveryWaitsForFillAndStopsAtLimit", NativeThemeResolverTests.RecoveryWaitsForFillAndStopsAtLimit),
                new TestCase("LateDonorsRestyleExistingBindingsOnce", NativeThemeResolverTests.LateDonorsRestyleExistingBindingsOnce),
                new TestCase("UnchangedButtonsAreNotRestyledByOptionalRetries", NativeThemeResolverTests.UnchangedButtonsAreNotRestyledByOptionalRetries),
                new TestCase("DestroyedAndMovedDonorsDiscardOnlyTheirCapability", NativeThemeResolverTests.DestroyedAndMovedDonorsDiscardOnlyTheirCapability),
                new TestCase("NewAllocatorOrHierarchyResetsRecoveryIdentity", NativeThemeResolverTests.NewAllocatorOrHierarchyResetsRecoveryIdentity),
                new TestCase("CapabilityApplicationFailureRestoresItsWholeGroup", NativeThemeResolverTests.CapabilityApplicationFailureRestoresItsWholeGroup),
                new TestCase("TeardownClearsOwnedBindingsAndFallbackFailureIsContained", NativeThemeResolverTests.TeardownClearsOwnedBindingsAndFallbackFailureIsContained),
                new TestCase("RespecFailedSourceWriteRollsBackExactSnapshot", PreviewSessionContinuityTests.RespecFailedSourceWriteRollsBackExactSnapshot),
                new TestCase("RespecNewProviderLockPreventsRoll", PreviewSessionContinuityTests.RespecNewProviderLockPreventsRoll),
                new TestCase("RespecDifferentCharacterHasNoAssignmentOrOrigin", PreviewSessionContinuityTests.RespecDifferentCharacterHasNoAssignmentOrOrigin),
                new TestCase("RespecSourceStagedBeforeNativeChecks", PreviewSessionContinuityTests.RespecSourceStagedBeforeNativeChecks),
                new TestCase("RespecPreviewStagedBeforeNativeChecks", PreviewSessionContinuityTests.RespecPreviewStagedBeforeNativeChecks),
                new TestCase("RespecNativeReplayOverwriteIsDetected", PreviewSessionContinuityTests.RespecNativeReplayOverwriteIsDetected),
                new TestCase("RespecMissingCopyCannotPassCoincidentalScores", PreviewSessionContinuityTests.RespecMissingCopyCannotPassCoincidentalScores),
                new TestCase("RespecReenteredCommitInvalidatesOldTicket", PreviewSessionContinuityTests.RespecReenteredCommitInvalidatesOldTicket),
                new TestCase("RespecPendingCommitDisablePreventsWrites", PreviewSessionContinuityTests.RespecPendingCommitDisablePreventsWrites),
                new TestCase("RespecLostOwnerDisableDoesNotRestoreAnotherUnit", PreviewSessionContinuityTests.RespecLostOwnerDisableDoesNotRestoreAnotherUnit),
                new TestCase("RespecDerivedStatsRefreshOnRollAndReturn", PreviewSessionContinuityTests.RespecDerivedStatsRefreshOnRollAndReturn),
                new TestCase("RespecMainCloneAdmitted", PreviewSessionContinuityTests.RespecMainCloneAdmitted),
                new TestCase("RespecMercenaryAdmitted", PreviewSessionContinuityTests.RespecMercenaryAdmitted),
                new TestCase("RespecStoryCompanionAdmitted", PreviewSessionContinuityTests.RespecStoryCompanionAdmitted),
                new TestCase("RespecNegativeContextMatrix", PreviewSessionContinuityTests.RespecNegativeContextMatrix),
                new TestCase("RespecConstructorIncompleteThenBound", PreviewSessionContinuityTests.RespecConstructorIncompleteThenBound),
                new TestCase("RespecReplacementKeepsAssignmentAndRng", PreviewSessionContinuityTests.RespecReplacementKeepsAssignmentAndRng),
                new TestCase("RespecPointBuyRestoresModifiedOrigin", PreviewSessionContinuityTests.RespecPointBuyRestoresModifiedOrigin),
                new TestCase("RespecOldRolledOriginDoesNotBecomeNewRoll", PreviewSessionContinuityTests.RespecOldRolledOriginDoesNotBecomeNewRoll),
                new TestCase("RespecReplayAndCopyReachOriginalRecipient", PreviewSessionContinuityTests.RespecReplayAndCopyReachOriginalRecipient),
                new TestCase("RespecPostCallbackOverwriteDetected", PreviewSessionContinuityTests.RespecPostCallbackOverwriteDetected),
                new TestCase("RespecMissingReplayCannotPass", PreviewSessionContinuityTests.RespecMissingReplayCannotPass),
                new TestCase("RespecWrongTargetCannotConsumeWrite", PreviewSessionContinuityTests.RespecWrongTargetCannotConsumeWrite),
                new TestCase("RespecDuplicateReplayDoesNotOverwriteIncrease", PreviewSessionContinuityTests.RespecDuplicateReplayDoesNotOverwriteIncrease),
                new TestCase("RespecDuplicateCompletionIsInert", PreviewSessionContinuityTests.RespecDuplicateCompletionIsInert),
                new TestCase("RespecCatchUpRetainsAbilityIncreases", PreviewSessionContinuityTests.RespecCatchUpRetainsAbilityIncreases),
                new TestCase("RespecRaceAndPermanentModifiersStaySeparate", PreviewSessionContinuityTests.RespecRaceAndPermanentModifiersStaySeparate),
                new TestCase("RespecCancelReopenStartsPointBuy", PreviewSessionContinuityTests.RespecCancelReopenStartsPointBuy),
                new TestCase("RespecOwnerLossPreventsLateWrites", PreviewSessionContinuityTests.RespecOwnerLossPreventsLateWrites),
                new TestCase("RespecCommitExceptionExpiresTicket", PreviewSessionContinuityTests.RespecCommitExceptionExpiresTicket),
                new TestCase("RespecDisableRestoresAndCloses", PreviewSessionContinuityTests.RespecDisableRestoresAndCloses),
                new TestCase("RespecUnrolledCompletionNeverWrites", PreviewSessionContinuityTests.RespecUnrolledCompletionNeverWrites),
                new TestCase("RespecHistoryRecallAndPointBuyOrigin", PreviewSessionContinuityTests.RespecHistoryRecallAndPointBuyOrigin),
                new TestCase("RolledIntelligenceRefreshesNativeSkillAllowance", PreviewSessionContinuityTests.RolledIntelligenceRefreshesNativeSkillAllowance),
                new TestCase("DerivedAllowanceRefreshIsIdempotentAcrossRerolls", PreviewSessionContinuityTests.DerivedAllowanceRefreshIsIdempotentAcrossRerolls),
                new TestCase("FailedDerivedRefreshFailsRollAndRollsBack", PreviewSessionContinuityTests.FailedDerivedRefreshFailsRollAndRollsBack),
                new TestCase("PointBuyReturnRefreshesDerivedAllowance", PreviewSessionContinuityTests.PointBuyReturnRefreshesDerivedAllowance),
                new TestCase("MercenaryCommitStagesScoresBeforeNativeReplay", PreviewSessionContinuityTests.MercenaryCommitStagesScoresBeforeNativeReplay),
                new TestCase("MercenaryReplayOverwriteFailsWithoutCorrectiveWrite", PreviewSessionContinuityTests.MercenaryReplayOverwriteFailsWithoutCorrectiveWrite),
                new TestCase("MercenaryDroppedSelectionsFailCompletion", PreviewSessionContinuityTests.MercenaryDroppedSelectionsFailCompletion),
                new TestCase("MercenaryInterruptedCommitRestoresExactPreCommitState", PreviewSessionContinuityTests.MercenaryInterruptedCommitRestoresExactPreCommitState),
                new TestCase("MercenaryCatchUpLevelNeverStagesStartingScores", PreviewSessionContinuityTests.MercenaryCatchUpLevelNeverStagesStartingScores),
                new TestCase("NewMainCommitStagesAndVerifiesAuthoritativeScores", PreviewSessionContinuityTests.NewMainCommitStagesAndVerifiesAuthoritativeScores),
                new TestCase("UpdateRestageAlsoRefreshesDerivedAllowances", PreviewSessionContinuityTests.UpdateRestageAlsoRefreshesDerivedAllowances),
                new TestCase("DerivedRefreshFailureOnPointBuyReturnIsReported", PreviewSessionContinuityTests.DerivedRefreshFailureOnPointBuyReturnIsReported),
                new TestCase("SpentBudgetRerollRefreshesBadgeAndBlocksNext", PreviewSessionContinuityTests.SpentBudgetRerollRefreshesBadgeAndBlocksNext),
                new TestCase("OverspendAfterLowerIntelligenceBlocksForward", PreviewSessionContinuityTests.OverspendAfterLowerIntelligenceBlocksForward),
                new TestCase("RepeatedDrawerCloseWithoutChangesIsHarmless", PreviewSessionContinuityTests.RepeatedDrawerCloseWithoutChangesIsHarmless),
                new TestCase("ForwardGuardIsScopedToOwnedSessionAndSkillsPhase", PreviewSessionContinuityTests.ForwardGuardIsScopedToOwnedSessionAndSkillsPhase),
                new TestCase("RerollWithIdenticalScoresStillSynchronizesExactlyOnce", PreviewSessionContinuityTests.RerollWithIdenticalScoresStillSynchronizesExactlyOnce),
                new TestCase("DrawerCloseSettlesSynchronizationAfterFailedCommand", PreviewSessionContinuityTests.DrawerCloseSettlesSynchronizationAfterFailedCommand),
                new TestCase("PreviewReplacementSynchronizesSkillsPage", PreviewSessionContinuityTests.PreviewReplacementSynchronizesSkillsPage),
                new TestCase("PointBuyReturnSynchronizesSkillsPageForPointBuyBudget", PreviewSessionContinuityTests.PointBuyReturnSynchronizesSkillsPageForPointBuyBudget),
                ...
                new TestCase("Wide point-buy panel exposes options", RollUiPresenterTests.WidePointBuyExposesOptionsWithoutDisclosure),
                new TestCase("Wide roll panel exposes ordinary sections", RollUiPresenterTests.WideRollModeExposesOrdinarySections),
                new TestCase("Wide roll panel compacts empty history", RollUiPresenterTests.WideEmptyHistoryCompactsSection),
                new TestCase("selected preset and applied rule remain distinct", RollUiPresenterTests.SelectedPresetAndAppliedRuleRemainDistinct),
                new TestCase("profile switching has no command side effects", RollUiPresenterTests.ProfileSwitchRenderingHasNoCommandSideEffects),
                new TestCase("main and mercenary presentation is identical", RollUiPresenterTests.CreationKindDoesNotChangePresentation),
                ...
                new TestCase("SuccessfulModesHaveNoMessageButKeepScores", RollUiPresenterTests.SuccessfulModesHaveNoMessageButKeepScores),
                new TestCase("FullActionableErrorWinsOverTransientStatus", RollUiPresenterTests.FullActionableErrorWinsOverTransientStatus),
                new TestCase("CloseActivationRoutesSynchronizationExactlyOnce", RollUiPresenterTests.CloseActivationRoutesSynchronizationExactlyOnce),
                new TestCase("AcceptedActivationRoutesOneCommandAndOneFeedback", RollUiPresenterTests.AcceptedActivationRoutesOneCommandAndOneFeedback),
                new TestCase("FeedbackFailureStillRoutesOneCommand", RollUiPresenterTests.FeedbackFailureStillRoutesOneCommand),
                new TestCase("CommandFailureIsNotRetriedOrSwallowed", RollUiPresenterTests.CommandFailureIsNotRetriedOrSwallowed),
                new TestCase("ThemeResolutionRetainsQualifiedObject", RollUiPresenterTests.ThemeResolutionRetainsQualifiedObject),
                new TestCase("ThemeConstructionUsesBoundedFallback", RollUiPresenterTests.ThemeConstructionUsesBoundedFallback),
                new TestCase("EmptyMessagesReserveNoFooterAndErrorsCanScroll", ResponsiveRollPanelLayoutTests.EmptyMessagesReserveNoFooterAndErrorsCanScroll),
                new TestCase("RequiredResolutionMatrixPreservesNavigationAndContentBounds", ResponsiveRollPanelLayoutTests.RequiredResolutionMatrixPreservesNavigationAndContentBounds),
                new TestCase("PresentationAndThemeFailurePreserveRealRollSession", ProductWorkflowTests.PresentationAndThemeFailurePreserveRealRollSession),
                ...
                new TestCase("native panel repeated construction failure exhausts", NativePanelConstructionBudgetTests.RepeatedFailureExhaustsConstruction),
                new TestCase("native panel allocator change reopens construction", NativePanelConstructionBudgetTests.AllocatorIdentityChangeReopensConstruction),
                new TestCase("native panel controller change reopens construction", NativePanelConstructionBudgetTests.ControllerIdentityChangeReopensConstruction),
                new TestCase("native panel same identity keeps failure count", NativePanelConstructionBudgetTests.SameIdentityObservationKeepsFailureCount),
                new TestCase("native panel successful construction clears failures", NativePanelConstructionBudgetTests.SuccessfulConstructionClearsFailureCount),
                new TestCase("button caption short keeps design width", ButtonCaptionFitTests.ShortCaptionKeepsDesignMinimum),
                new TestCase("button caption long reserves text and padding", ButtonCaptionFitTests.LongCaptionReservesTextPlusPadding),
                new TestCase("button caption padding counted once per side", ButtonCaptionFitTests.PaddingCountedOncePerSide),
                new TestCase("button caption invalid measurement falls back", ButtonCaptionFitTests.InvalidMeasurementFallsBackToDesign),
                new TestCase("button caption height includes insets", ButtonCaptionFitTests.HeightIncludesVerticalInsets),
                new TestCase("button caption pair uses wider control", ButtonCaptionFitTests.PairUnificationUsesTheWiderControl),
                new TestCase("button caption rows fit wide content", ButtonCaptionFitTests.RealisticCaptionRowsFitWideContent),
                new TestCase("button caption compact reflow bounded", ButtonCaptionFitTests.CompactReflowKeepsRowsWithinBounds),
                ...
                new TestCase("native panel uses separate native inset paper", NativePanelUsabilityTests.LayoutUsesSeparateNativeInsetPaper),
                new TestCase("native panel expanded dimensions bounded", NativePanelUsabilityTests.ExpandedDimensionsAreBounded),
                new TestCase("native panel header and Close dimensions bounded", NativePanelUsabilityTests.HeaderAndCloseDimensionsAreBounded),
                ...
                new TestCase("native panel access anchor uses bottom-center ability geometry", NativePanelUsabilityTests.AccessTabUsesBottomCenterAbilityGeometry),
                new TestCase("collapsed access tab prefers active racial geometry", CollapsedAccessTabLayoutTests.PreferredRacialAnchorIsBottomCentered),
                new TestCase("collapsed access tab handles missing racial geometry", CollapsedAccessTabLayoutTests.MissingRacialAnchorUsesAllocatorFrame),
                new TestCase("collapsed access tab handles inactive racial geometry", CollapsedAccessTabLayoutTests.InactiveRacialAnchorUsesAllocatorFrame),
                new TestCase("collapsed access tab rejects unsuitable racial geometry", CollapsedAccessTabLayoutTests.UnsuitableRacialAnchorUsesAllocatorFrame),
                new TestCase("collapsed access tab clamps constrained width", CollapsedAccessTabLayoutTests.ConstrainedWidthClampsInsideSafeBounds),
                new TestCase("collapsed access tab preserves constrained-height navigation inset", CollapsedAccessTabLayoutTests.ConstrainedHeightPreservesNavigationInset),
                new TestCase("collapsed access tab honors bottom navigation inset", CollapsedAccessTabLayoutTests.BottomNavigationInsetMovesAccessTabUpward),
                new TestCase("collapsed access tab has no upper-right fallback", CollapsedAccessTabLayoutTests.MissingAbilityChildrenNeverUsesUpperRight),
                new TestCase("collapsed access tab centers within ability region", CollapsedAccessTabLayoutTests.AccessTabCentersWithinVerifiedAbilityRegion),
                new TestCase("collapsed access tab is bounded at 1152x720", CollapsedAccessTabLayoutTests.Resolution1152x720IsBounded),
                new TestCase("collapsed access tab is bounded at 1280x720", CollapsedAccessTabLayoutTests.Resolution1280x720IsBounded),
                new TestCase("collapsed access tab is bounded at 1366x768", CollapsedAccessTabLayoutTests.Resolution1366x768IsBounded),
                new TestCase("collapsed access tab is bounded at 1600x900", CollapsedAccessTabLayoutTests.Resolution1600x900IsBounded),
                new TestCase("collapsed access tab is bounded at 1920x1080", CollapsedAccessTabLayoutTests.Resolution1920x1080IsBounded),
                ...
                new TestCase("native panel creation-owner transition resets presentation", NativePanelUsabilityTests.MovingBetweenCreationOwnersResetsPresentation),
                new TestCase("responsive profile is not character state", NativePanelUsabilityTests.ResponsiveProfileIsNotCharacterState),
                new TestCase("responsive panel ample bounds select Wide", ResponsiveRollPanelLayoutTests.AmpleBoundsSelectWide),
                new TestCase("responsive panel constrained width selects Compact", ResponsiveRollPanelLayoutTests.ConstrainedWidthSelectsCompact),
                new TestCase("responsive panel constrained height selects Compact", ResponsiveRollPanelLayoutTests.ConstrainedHeightSelectsCompact),
                new TestCase("responsive panel clamps to safe bounds", ResponsiveRollPanelLayoutTests.PreferredDimensionsClampToSafeBounds),
                new TestCase("responsive panel preserves safe insets", ResponsiveRollPanelLayoutTests.SafeInsetsArePreserved),
                new TestCase("responsive panel body cannot be negative", ResponsiveRollPanelLayoutTests.BodyViewportCannotBecomeNegative),
                new TestCase("responsive Wide point buy does not scroll", ResponsiveRollPanelLayoutTests.OrdinaryWidePointBuyDoesNotScroll),
                new TestCase("responsive Wide roll mode does not scroll", ResponsiveRollPanelLayoutTests.OrdinaryWideRollModeDoesNotScroll),
                new TestCase("responsive oversized content scrolls", ResponsiveRollPanelLayoutTests.OversizedContentRequiresScrolling),
                new TestCase("responsive profile hysteresis prevents flicker", ResponsiveRollPanelLayoutTests.SmallGeometryChangesDoNotFlickerProfile),
                new TestCase("responsive scroll hysteresis prevents flicker", ResponsiveRollPanelLayoutTests.SmallContentChangesDoNotFlickerScrolling),
                new TestCase("responsive calculation has no random side effects", ResponsiveRollPanelLayoutTests.LayoutCalculationHasNoRandomSideEffects),
                ...
                new TestCase("mercenary marker rejects respec", CharacterCreationContextPolicyTests.MercenaryMarkerAloneDoesNotAuthorizeRespec),
                ...
                new TestCase("context rejects respec without qualified launch", CharacterCreationContextPolicyTests.RespecWithoutLaunchRejectedWhenMainMatches),
                ...
                new TestCase("preview match alone cannot complete mercenary finalization", PreviewSessionContinuityTests.PreviewMatchAloneCannotCompleteMercenaryFinalization),
                new TestCase("mercenary assignment reaches authoritative final descriptor", PreviewSessionContinuityTests.MercenaryAssignmentReachesAuthoritativeFinalDescriptor),
                new TestCase("mercenary final-state mismatch is detected", PreviewSessionContinuityTests.MercenaryFinalStateMismatchIsDetected),
                new TestCase("main character cannot use mercenary finalization seam", PreviewSessionContinuityTests.MainCharacterCannotUseMercenaryFinalizationSeam),
                new TestCase("different finalization owner cannot receive assignment", PreviewSessionContinuityTests.DifferentFinalizationOwnerCannotReceiveAssignment),
                new TestCase("preview replacement preserves one assignment through finalization", PreviewSessionContinuityTests.PreviewReplacementPreservesOneAssignmentThroughFinalization),
                new TestCase("duplicate mercenary completion observation is idempotent", PreviewSessionContinuityTests.DuplicateMercenaryCompletionObservationIsIdempotent),
                new TestCase("success callback owner release still verifies final descriptor", PreviewSessionContinuityTests.SuccessCallbackOwnerReleaseStillVerifiesFinalDescriptor),
                new TestCase("canceled mercenary cannot commit late", PreviewSessionContinuityTests.CanceledMercenaryCannotCommitLate),
                new TestCase("mercenary ownership loss cannot commit late", PreviewSessionContinuityTests.MercenaryOwnershipLossCannotCommitLate),
                new TestCase("mercenary finalization keeps racial modifiers separate", PreviewSessionContinuityTests.MercenaryFinalizationKeepsRacialModifiersSeparate),
